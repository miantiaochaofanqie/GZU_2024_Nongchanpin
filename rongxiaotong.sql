...
INSERT INTO `tb_order` VALUES (100, '求购青苹果', 120.00, '求购40斤青苹果，有意者私聊', 0, 'needs', 'picturetb_ordereffaf0126a2541c4a18f8431051743ac.jpg', 'zhangxukun', NULL, '2021-08-27 16:57:29', '2021-08-27 16:57:29', '山东省威海市');
...
BEGIN
    ...
    IF l1 = 0 THEN RETURN 0; END IF;
    IF l2 = 0 THEN RETURN 0; END IF;

    SET i = 0;
    SET sum = 0;
    myloop1: LOOP
        SET i = i + 1;
        IF i > l1 THEN LEAVE myloop1; END IF;
        SET _ss = SUBSTR(s1, i, 1);
        SET j = 0;
        myloop2: LOOP
            SET j = j + 1;
            IF j > l2 THEN LEAVE myloop2; END IF;
